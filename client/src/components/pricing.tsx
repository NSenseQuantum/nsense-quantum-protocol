  ...
  const plans = [
    {
      ...
      features: [
        ...
        { name: "2 platform integrations", included: true },
        { name: "Custom templates", included: true },
        { name: "Email support", included: true },
        { name: "Advanced AI features", included: false },
        { name: "Priority support", included: false },
      ],
      limit: "Up to 1,000 feedback/month",
      popular: false,
    ...
    },
    {
      ...
      features: [
        { name: "Advanced AI sentiment analysis", included: true },
        { name: "10 platform integrations", included: true },
        { name: "Unlimited templates", included: true },
        { name: "Auto-response system", included: true },
        { name: "Advanced analytics", included: true },
        { name: "Priority support", included: true },
      ],
      limit: "Up to 10,000 feedback/month",
      popular: true,
    ...
    },
    {
      ...
      features: [
        { name: "Quantum AI processing", included: true },
